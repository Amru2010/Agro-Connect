          ...
          >
            ...
            {cookies.user_access_token && (
              <div
                ...
                } top-8 right-0 font-medium bg-white rounded-lg shadow-md pl-1 md:pl-4 pr-2 md:pr-8 py-0 md:py-2 z-30`}
              >
          ...
          >
            ...
            {cookies.seller_access_token && (
              <div
                ...
                } top-8 right-0 z-30 font-medium bg-white rounded-lg shadow-md pl-1 md:pl-4 pr-2 md:pr-8 py-0 md:py-2`}
              >
